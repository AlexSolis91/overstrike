// ==================== DATOS DE PERSONAJES ====================
        ...
        const RELICS_DATA = {
            ...
            'Espadas del Caos':          { tier:'Epico',     slotCategory:'Arma',       subtype:'Espada',    slot:'Arma',   img:'https://i.ibb.co/RGv0GXvr/Gemini-Generated-Image-3sjsry3sjsry3sjs.jpg', effect:'elfr_espadas_caos',       desc:'Cada crítico causa daño adicional a un enemigo aleatorio igual al 10% del HP máx del portador (no aplica en Jefes de Sala) y aumenta su HP máx en +2. Si el objetivo del portador es un Jefe de Sala: 80% de probabilidad de daño doble y 20% de daño triple.' },
