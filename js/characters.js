// ==================== DATOS DE PERSONAJES ====================
        ...
        const RELICS_DATA = {
            ...
            'Arco Granizo':           { tier:'Raro',      slotCategory:'Arma',      subtype:'Arco',      slot:'Arco',    img:'https://i.ibb.co/C5Np5yH9/Gemini-Generated-Image-7e4gh67e4gh67e4g.png',   effect:'ice_arrow_charge',   desc:'Al aplicar Congelación al objetivo → +1 carga.' },
            ...
            'Vortex':                 { tier:'Legendario',slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/tphxyvrS/image-f7fb9e22.png',                           effect:'vortex_aoe_ignore',  desc:'Ignora Esquiva Área. Daño doble a enemigos con Esquiva Área.' },
            ...
            'Skeggöx':                { tier:'Epico',     slotCategory:'Arma',      subtype:'Hacha',     slot:'Arma',    img:'https://i.ibb.co/dwjtVByZ/image-8ea3867b.png',                           effect:'skeggox_prov',       desc:'Al golpear enemigo con Provocación o Mega Provocación → turno adicional e ignora Prov/MegaProv el resto de la ronda.' },
            'Ballesta de Cristal':    { tier:'Raro',      slotCategory:'Arma',      subtype:'Arco',      slot:'Arco',    img:'https://i.ibb.co/hzssnGQ/image-6c6785f0.png',                           effect:'crystal_bow',        desc:'Al golpear enemigo sin cargas → +2 cargas.' },
            ...
            'Escudo de Espejo':       { tier:'Especial',  slotCategory:'Arma',      subtype:'Escudo',    slot:'Escudo',  img:'https://i.ibb.co/pDbYQ7r/image-de6624f.png',                            effect:'mirror_shield',      desc:'25% de reflejar el ataque al atacante.' },
            ...
            'Espada Nichirin Negra':  { tier:'Epico',     slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/9mGCFpQF/image-31f4293b.png',                          effect:'nichirin_black',     desc:'Aplica Quemadura Solar con ataques. Daño doble a enemigos con Quemadura Solar.' },
            ...
            'Capa de Invisibilidad':  { tier:'Raro',      slotCategory:'Equipacion', subtype:'Capa',     slot:'Armadura',img:'https://i.ibb.co/TDMNfNsY/image-c0ca5843.png',                           effect:'cloak_stealth',      desc:'Al inicio de cada ronda, 50% de aplicar Esquivar y Sigilo.' },
            'Escamas de Kindora':     { tier:'Epico',     slotCategory:'Equipacion', subtype:'Vestidura',slot:'Armadura',img:'https://i.ibb.co/rG09GYGR/image-5fc4b067.png',                           effect:'kindora_hp50',       desc:'HP máximo del portador aumenta 50%.', hpPctBonus:0.50 },
            ...
            'Arcillos del Alba':      { tier:'Raro',      slotCategory:'Joya',       subtype:'Arcillos', slot:'Joya',    img:'https://i.ibb.co/8D80f9hX/Captura-de-pantalla-2026-04-30-120759.png',     effect:'hp_vel_plus3',       desc:'+3 HP máximo y +3 velocidad.', hpBonus:3, velBonus:3 },
            'Anillo de la Verdad':    { tier:'Raro',      slotCategory:'Joya',       subtype:'Anillo',   slot:'Joya',    img:'https://i.ibb.co/0j9p3ZDM/Gemini-Generated-Image-y5zwy7y5zwy7y5zw.png',  effect:'debuff_cleanse_15',  desc:'15% de limpiar un debuff al recibirlo.' },
            ...
            'Anillo del Tiempo':      { tier:'Legendario',slotCategory:'Joya',       subtype:'Anillo',   slot:'Joya',    img:'https://i.ibb.co/4wKysxTx/image-2ccf255a.png',                           effect:'ring_of_time',       desc:'Única vez: al ser derrotado revive con 100% HP y 20 cargas. Por cada especial/over enemigo → +10 cargas y turno adicional.' },
            'Palantir':               { tier:'Epico',     slotCategory:'Joya',       subtype:'Orbe',     slot:'Joya',    img:'https://i.ibb.co/9mYGrfWT/image-38dcb910.png',                           effect:'palantir_ignore',    desc:'Ignora Provocación, Mega Provocación y Sigilo. Aplica Posesión a los objetivos.' },
            'Ojo de Serpiente':       { tier:'Especial',  slotCategory:'Joya',       subtype:'Orbe',     slot:'Joya',    img:'https://i.ibb.co/bjrdDzBF/image-ba09b3a0.png',                           effect:'snake_eye_poison',   desc:'Si objetivo golpeado tiene stacks de Veneno activo → aplica misma cantidad a todos los demás enemigos.' },
            'Ojo de Gorgona':         { tier:'Epico',     slotCategory:'Joya',       subtype:'Orbe',     slot:'Joya',    img:'https://i.ibb.co/rKvN3qL2/image-dd06954e.png',                           effect:'gorgon_eye_heal',    desc:'Daño ST sobre enemigo → cura HP a todos los aliados = mitad del daño causado.' },
