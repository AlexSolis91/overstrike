// ==================== DATOS DE PERSONAJES ====================
        ...
        const RELICS_DATA = {
            ...
            'Espadas del Caos':          { tier:'Epico',     slotCategory:'Arma',       subtype:'Espada',    slot:'Arma',   img:'https://i.ibb.co/RGv0GXvr/Gemini-Generated-Image-3sjsry3sjsry3sjs.jpg', effect:'elfr_espadas_caos',       desc:'Cada golpe crítico causa daño adicional a un enemigo aleatorio equivalente al 25% del HP máx del objetivo golpeado (no aplica en Jefes de Sala) y aumenta los HP máx del portador en +3. Si el objetivo es un Jefe de Sala: 80% daño doble y 20% daño triple.' },
