// ==================== DATOS DE PERSONAJES ====================
        const characterData = {
            ...
            'Sauron': {
                ...
                abilities: [
                    ...
                    { name: 'Poder del Anillo', type: 'over', cost: 12, chargeGain: 0, damage: 0, target: 'self', effect: 'poder_anillo_sauron_v2', description: 'Por cada reliquia equipada, cura 10% de su HP máximo y gana +10 HP máximo (20%/+20 si es Legendaria) — sumado entre todas. Causa daño igual al HP curado, repartido entre hasta 3 enemigos aleatorios. Si un enemigo muere por este daño, Sauron gana 1 turno adicional.' }
                ]
            },
        ...
        const RELICS_DATA = {
            ...
            'Sable de Luz de Obi-Wan':   { tier:'Epico',     slotCategory:'Arma',       subtype:'Espada',    slot:'Arma',   img:'https://i.ibb.co/DDp2xbnQ/Gemini-Generated-Image-vom5hgvom5hgvom5.jpg', effect:'elfr_sable_obiwan',       desc:'Cada golpe genera Escudo igual al daño causado (acumulable). Consume 10 de Escudo para limpiar un debuff entrante. +2% de daño por cada punto de Escudo activo.' },
