// ==================== DATOS DE PERSONAJES ====================
        ...
        const RELICS_DATA = {
            ...
            'Espadas del Caos':          { tier:'Epico',     slotCategory:'Arma',       subtype:'Espada',    slot:'Arma',   img:'https://i.ibb.co/RGv0GXvr/Gemini-Generated-Image-3sjsry3sjsry3sjs.jpg', effect:'elfr_espadas_caos',       desc:'Cada crítico sobre un objetivo causa daño adicional = 2% del HP máx del portador (+2% acumulable por cada crítico acertado, se reinicia al iniciar partida) y +5 HP máx al portador. No aplica en Jefes de Sala: en su lugar, todos los ataques del portador tienen 80% de daño doble y 20% de daño triple.' },
