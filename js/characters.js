// ==================== DATOS DE PERSONAJES ====================
        const characterData = {
            ...
            'Madara Uchiha': {
                ...
                abilities: [
                    ...
                    { name: 'Susanoo', type: 'special', cost: 6, chargeGain: 0, damage: 4, target: 'single', effect: 'susanoo_madara', description: 'Antes de golpear, disipa todos los Buffs del objetivo. Madara se aplica Escudo 4HP. Si es crítico (50%), roba 3HP del objetivo. Aplica Quemadura Solar 2T sobre el objetivo.' },
            ...
            'Rengoku': {
                ...
                abilities: [
                    ...
                    { name: 'Mar de Fuego', type: 'special', cost: 4, chargeGain: 0, damage: 4, target: 'aoe', effect: 'mar_fuego_rengoku', ignoresEsquivaArea:true, description: 'Causa 4 AOE. Ignora Esquiva Área. Disipa buffs activos de los objetivos. Aplica Quemadura 1HP. Si ya tenían Quemadura antes del ataque: 100% de crítico.' },
            ...
            'Thestalos': {
                ...
                abilities: [
                    ...
                    { name: 'Juicio del Astro Rey',     type: 'over',    cost: 8, chargeGain: 0, damage: 4, target: 'single', effect: 'juicio_astro_rey_thes',      description: 'Causa 4 daño ST. Aplica Quemadura 4HP a todo el equipo enemigo. Cada uso duplica el daño base y el HP de las quemaduras de este movimiento. El máximo de daño que puede hacer este movimiento a un Jefe de Sala son 150.' }
                ]
            },
            ...
            'Ragnar Lothbrok': {
                ...
                abilities: [
                    ...
                    { name: 'Tormenta del Norte',type: 'special', cost: 6,  chargeGain: 0, damage: 1, target: 'mt',     effect: 'tormenta_norte_v3', description: '10 golpes MT 1 daño + Sangrado. Por cada Sangrado que se convierta en Hemorragia: equipo aliado +3 HP de escudo.' },
            ...
            'Sauron': {
                ...
                statusEffects: [], shield: 0, shieldEffect: null, isDead: false,
                portrait: 'https://i.ibb.co/WvcSkpYH/Sauron.jpg',
                passive: { name: 'El Ojo que Todo lo Ve', description: 'Por cada Anillo equipado, todos los ataques de Sauron ganan +5 de daño base. Con 2 reliquias Épicas equipadas, solo puede recibir daño de ataques reales de enemigos con al menos 1 reliquia Legendaria de Arma. Con 1 Anillo Legendario equipado, genera 20 cargas al inicio de cada ronda. Con 2 reliquias Especiales equipadas, es inmune a Miedo y Confusión. Con 3 reliquias Raras equipadas, todos sus ataques aplican Mega Posesión. Al inicio de cada ronda, gana +5 velocidad y +5 HP máximo por cada Anillo equipado (sin límite). Con un Yelmo equipado, regenera 10 HP cada vez que recibe un golpe. Con una Capa equipada, sus ataques roban 8 HP del objetivo golpeado. Con 3 reliquias Legendarias equipadas, es inmune a debuffs. Con las 6 reliquias equipadas siendo Legendarias, no recibe daño mientras haya otro aliado vivo.' },
                abilities: [
                    { name: 'Voluntad de Mordor', type: 'basic', cost: 0, chargeGain: 1, damage: 1, target: 'single', effect: 'voluntad_mordor_sauron_v2', description: 'Si el objetivo tenía Mega Posesión activa antes del ataque, todos los aliados generan 5 cargas. Si tenía Megacongelación activa, causa daño a todo el equipo enemigo igual al 50% del HP máximo de Sauron. Si tenía Mega Aturdimiento activa, revive hasta 2 aliados muertos con 100% HP y 20 cargas.' },
                    { name: 'Mano Negra', type: 'special', cost: 4, chargeGain: 0, damage: 3, target: 'aoe', effect: 'mano_negra_sauron_v2', description: 'Por cada reliquia de tipo Yelmo, Botas, Armadura, Anillo o Maza equipada en Sauron, aplica 1 debuff aleatorio (Mega Posesión, Mega Aturdimiento, Megacongelación, Posesión, Aturdimiento o Congelación) a un enemigo aleatorio.' },
                    { name: 'Señor Oscuro', type: 'special', cost: 6, chargeGain: 0, damage: 6, target: 'single', effect: 'senor_oscuro_sauron_v2', description: 'Si el objetivo tiene Provocación o Mega Provocación (buff o pasiva), causa daño igual al 50% del HP máximo de Sauron a 2 enemigos aleatorios. Recupera 50% de su HP máximo por cada enemigo eliminado por este ataque.' },
                    { name: 'Poder del Anillo', type: 'over', cost: 12, chargeGain: 0, damage: 0, target: 'self', effect: 'poder_anillo_sauron_v2', description: 'Por cada reliquia equipada, cura 5% de su HP máximo y gana +5 HP máximo (10%/+10 si es Legendaria) — sumado entre todas. Causa daño igual al HP curado, repartido entre hasta 3 enemigos aleatorios.' }
                ]
            },
            ...
            'Seiya': {
                ...
                statusEffects: [], shield: 0, shieldEffect: null, isDead: false,
                _hpLostThisRound: 0, _seiyaShieldApplied: false,
            ...
            'Omni-Man': {
                ...
                statusEffects: [], shield: 0, shieldEffect: null, isDead: false,
                _impactoBaseDmg: 1,
                portrait: 'https://i.ibb.co/1GdnQPsF/Omni-Man-Nolan-Grayson-Invincible.jpg',
                passive: { name: 'Orgullo Viltrumita', description: 'Cada vez que un debuff es aplicado al equipo aliado, Omni-Man ejecuta Arremetida Planetaria automáticamente. Cada vez que un buff es aplicado al equipo enemigo, Omni-Man genera 3 cargas. Cada vez que Omni-Man usa Impacto Supersónico, su daño base aumenta +1 permanentemente.' },
                abilities: [
                    { name: 'Impacto Supersónico',  type: 'basic',   cost: 0,  chargeGain: 2, damage: 1, target: 'single', effect: 'impacto_supersonico_om',  description: 'Causa daño ST (aumenta +1 permanentemente por cada uso). 50% crítico. 10% daño triple.' },
                    { name: 'Arremetida Planetaria', type: 'special', cost: 5,  chargeGain: 1, damage: 1, target: 'aoe',    effect: 'arremetida_planetaria_om', description: 'Causa 1 AOE. 50% aturdimiento por enemigo. 10% de +6 daño adicional por enemigo.' },
                    { name: 'Presión Absoluta',      type: 'special', cost: 8,  chargeGain: 0, damage: 8, target: 'single', effect: 'presion_absoluta_om',      description: 'Causa 8 daño ST. Aplica Mega Aturdimiento. Si elimina al objetivo, Omni-Man se cura 10 HP.' },
                    { name: 'Orden Viltrumita',      type: 'over',    cost: 10, chargeGain: 0, damage: 10, target: 'single', effect: 'orden_viltrumita_om',     description: 'Causa 10 daño ST. Si elimina al objetivo, se ejecuta de nuevo sobre un enemigo aleatorio. Por cada eliminación, un aliado aleatorio gana 10 cargas.' }
                ]
            },
            'Lagertha': {
            ...
            'Antares': {
                ...
                abilities: [
                    ...
                    { name: 'Aliento de la Destruccion', type: 'over', cost: 12, chargeGain: 0, damage: 5, target: 'aoe', effect: 'aliento_destruccion_antares', ignoresEsquivaArea:true, description: 'Causa 5 AOE. Ignora Esquiva Área (buff y pasiva). Transformado en Dragon de la Destruccion: aplica Quemadura 5HP a los objetivos.' }
                ]
            },
            ...
            'Jaina Proudmoore': {
                ...
                abilities: [
                    ...
                    { name: 'Granizo de Arena Imperial', type: 'special', cost: 6, chargeGain: 0, damage: 3, target: 'aoe', effect: 'granizo_arena_gaara', ignoresEsquivaArea:true, ignoresMegaProvocacion:true, description: 'Causa 3 AOE. Ignora Esquiva Área y Mega Provocación. Triple daño si vel ≤ 70. Invocaciones golpeadas tienen 50% de ser eliminadas sin activar su pasiva.' },
            ...
            'Meliodas': {
                ...
                abilities: [
                    ...
                    { name: 'El Rey Demonio',       type: 'over',    cost: 12, chargeGain: 0, damage: 0, target: 'self',   effect: 'rey_demonio_meliodas',    description: 'Transformación permanente: +10 velocidad. Cada vez que Meliodas aplica Sangrado a un enemigo, un aliado aleatorio gana 2 cargas. Solo usable si Meliodas no está transformado.' },
                ]
            },
            ...
            'Pain': {
                ...
                abilities: [
                    ...
                    { name: 'Shinra Tensei',                type: 'over',    cost: 15, chargeGain: 0, damage: 0, target: 'aoe',   effect: 'shinra_tensei_pain',   description: 'Elimina todas las cargas de ambos equipos. Daño total = cargas eliminadas × multiplicador (5 aliados=×1.0, 4=×1.5, 3=×2.0, 2=×2.5, 1=×3.0). El daño se reparte aleatoriamente entre todos los enemigos.' },
                ]
            },
            ...
            'Gogeta': {
                ...
                abilities: [
                    ...
                    { name: 'Galick Ho',              type: 'special', cost: 7,  chargeGain: 0, damage: 5, target: 'aoe',    effect: 'gogeta_galick_ho',     description: 'AOE 5 daño. Disipa todos los buffs del equipo enemigo e inflige +1 de daño por cada buff disipado.' },
                    { name: 'Kame Hame Ha',           type: 'special', cost: 9,  chargeGain: 0, damage: 5, target: 'aoe',    effect: 'gogeta_kamehameha',    description: 'AOE 5 daño. Aplica 5 debuffs de esta lista a cada objetivo golpeado, sin repetir ninguno sobre el mismo objetivo: Quemadura 3 HP, Quemadura Solar 2T, Sangrado 2T, Debilitar 2T, Ceguera 2T, Aturdimiento, Silenciar 2T y Congelación.' },
            ...
            'Arthas Menethil': {
                ...
                passive: { name: 'Aura Sagrada Distorsionada', description: 'Al inicio de la ronda 6, Arthas se transforma en el Caballero de la Muerte. Cada vez que un enemigo recibe curación, Arthas genera 5 cargas y gana turno adicional (una vez por cada enemigo curado). Cada vez que un aliado recibe un debuff, cura 3 HP al aliado con menos HP del equipo.' },
                abilities: [
                    ...
                    { name: 'Guerrero de la Luz',      type: 'special', cost: 0,  chargeGain: 4, damage: 1, target: 'aoe',    effect: 'arthas_warrior',  description: 'Aplica debuff Ceguera. Si los objetivos tenían buffs activos antes del ataque, elimina 7 cargas a los objetivos golpeados.' },
                    { name: 'Escudo Divino',            type: 'special', cost: 7,  chargeGain: 0, damage: 0, target: 'self',   effect: 'arthas_shield',   description: 'Aplica buff Escudo Sagrado a los 3 aliados con menos HP.' },
                    { name: 'Consagración',             type: 'over',    cost: 15, chargeGain: 0, damage: 5, target: 'single', effect: 'arthas_consecrate', description: 'Si el objetivo tiene Provocación o Mega Provocación, inflige el 80% de sus HP totales. +5 daño por cada reliquia equipada en el objetivo.' }
                ],
                ...
                statusEffects: [], shield: 0, shieldEffect: null, isDead: false,
                portrait: 'https://i.ibb.co/ccQczyRr/descarga-24.jpg',
                passive: { name: 'Visión de Profeta', description: 'Grindelwald es inmune a Confusión, Posesión y Aturdimiento. Cada vez que un buff se aplique en un enemigo, limpia ese buff y 2 buffs más de 2 enemigos aleatorios. Cada vez que un enemigo usa una habilidad AOE, Grindelwald lanza Infierno Azul automáticamente.' },
                abilities: [
                    { name: 'Confundus',              type: 'basic',   cost: 0,  chargeGain: 4, damage: 2, target: 'single', effect: 'confundus_grindelwald',           description: 'Causa 2 daño ST. Si el objetivo ya tenía un Buff activo antes del ataque, aplica Mega Posesión a 2 enemigos aleatorios.' },
                    { name: 'Protego Diabolica',      type: 'special', cost: 7,  chargeGain: 0, damage: 0, target: 'self',   effect: 'protego_diabolica_grindelwald',   description: 'Disipa los debuffs del equipo aliado y aplica Escudo 1 HP por debuff disipado. Aplica Buff Aura de Fuego al equipo aliado por 3 turnos.' },
                    { name: 'Infierno Azul',          type: 'special', cost: 10, chargeGain: 0, damage: 1, target: 'aoe',    effect: 'infierno_azul_grindelwald', ignoresEsquivaArea:true,       description: 'AOE 1 daño — ignora Esquiva Área. Aplica Quemadura 3HP y Quemadura Solar a todos los enemigos. Disipa los buffs de los objetivos golpeados y genera 1 carga al equipo aliado por buff disipado.' },
            ...
            'Doctor Doom': {
                ...
                passive: { name: 'Aura de Latveria', description: 'Cuando un enemigo recupera HP (applyHeal), el equipo aliado recupera la misma cantidad de HP. Una sola vez por ronda, cuando un debuff es aplicado sobre Doctor Doom, aplica buff Protección Sagrada sobre Doctor Doom y disipa todos los debuffs activos en el equipo aliado. Cada vez que Doctor Doom es atacado mientras tenga activo buff Protección Sagrada o Escudo Sagrado, roba 3 cargas de cada enemigo.' },
                abilities: [
                    { name: 'Guantelete de Plasma',     type: 'basic',   cost: 0,  chargeGain: 1, damage: 2, target: 'aoe',    effect: 'doom_gauntlet',        description: 'AOE 2 daño. Si golpea a un enemigo con Provocación/MegaProvocación, todos los demás enemigos reciben daño adicional igual al recibido por ese enemigo. 50% de probabilidad por enemigo golpeado de aumentar HP máximo de Doctor Doom en +1 (sin tope).' },
                    { name: 'Escudo Molecular',          type: 'special', cost: 3, chargeGain: 0, damage: 0, target: 'self',   effect: 'doom_force_field',     description: 'Doctor Doom se aplica buff Escudo Sagrado (2 turnos) y gana 1 turno adicional.' },
                    ...
                    { name: 'Dios Emperador Doom',      type: 'over',    cost: 12, chargeGain: 0, damage: 10, target: 'single', effect: 'doom_god_emperor',    description: 'ST 10 daño. El equipo aliado recupera 50 HP repartidos al azar entre los aliados vivos. Por cada punto de HP efectivamente curado, causa 1 daño a un enemigo aleatorio.' }
                ]
            },
            ...
            'Aragorn': {
                ...
                abilities: [
                    ...
                    { name:'Ejército del Inframundo',      type:'over',    cost:13, chargeGain:0, damage:5, target:'aoe',    effect:'aragorn_ejercito',        description:'AOE 5 daño. +3 de daño adicional por cada personaje muerto. Si un enemigo muere con este ataque, revive a un aliado aleatorio con 100% de su HP y 0 cargas.' }
                ],
            ...
            'Tokito': {
                ...
                abilities: [
                    ...
                    { name: 'Luna Negra',                       type: 'special', cost: 8,  chargeGain: 0, damage: 4,  target: 'aoe',     effect: 'tokito_luna_negra', ignoresEsquivaArea:true,     description: 'Este ataque ignora Buff Esquivar y Buff Esquiva Área.' },
            ...
            'Soldier Boy': {
                ...
                abilities: [
                    ...
                    { name: 'Explosión Radioactiva',     type: 'over',    cost: 14, chargeGain: 0, damage: 0, target: 'aoe',    effect: 'soldierboy_over', ignoresEsquivaArea:true, ignoresMegaProvocacion:true,     description: 'Ignora Mega Provocación, Esquivar y Esquiva Área. Elimina todas las cargas y disipa todos los buffs del equipo enemigo. Aplica Quemadura Solar y Debilitar (2 turnos) a todo el equipo enemigo.' }
                ]
            },
        ...
        const RELICS_DATA = {
            ...
            'Ergonos':                { tier:'Legendario',slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/fVjsbMwg/Gemini-Generated-Image-mo8zwgmo8zwgmo8z.png',   effect:'ergonos_basic',      desc:'Duplica cargas del básico del portador. Al usar básico, el equipo aliado genera las mismas cargas que el portador. Los ataques ST del portador aplican Megacongelación al objetivo y Congelación a 2 enemigos aleatorios.' },
            'Pyrophagos':             { tier:'Epico',     slotCategory:'Arma',      subtype:'Lanza',     slot:'Arma',    img:'https://i.ibb.co/Y7n0KDPW/Gemini-Generated-Image-ybgturybgturybgt.png',   effect:'pyro_st_burn',       desc:'Ataque ST sobre enemigo con Quemadura → duplica Quemadura y +3 daño adicional.' },
            'Aguijón Esmeralda':      { tier:'Epico',     slotCategory:'Arma',      subtype:'Daga',      slot:'Arma',    img:'https://i.ibb.co/pjHTcmKZ/Gemini-Generated-Image-8p0wjx8p0wjx8p0w.png',   effect:'poison_spread',      desc:'Una vez por ronda: cuando un enemigo recibe daño por Veneno, aplica 2 stacks de Veneno a cada enemigo. Si el portador ataca a un enemigo con Veneno, cura 1 HP a todos los aliados por cada debuff Veneno activo en el campo (de ambos equipos).' },
            'Arco Granizo':           { tier:'Raro',      slotCategory:'Arma',      subtype:'Arco',      slot:'Arco',    img:'https://i.ibb.co/C5Np5yH9/Gemini-Generated-Image-7e4gh67e4gh67e4g.png',   effect:'freeze_charge',   desc:'Al aplicar Congelación al objetivo → +1 carga.' },
            'Eco Sanador':            { tier:'Epico',     slotCategory:'Arma',      subtype:'Baculo',    slot:'Arma',    img:'https://i.ibb.co/WpRwtvfh/Gemini-Generated-Image-3almna3almna3alm.png',   effect:'double_heal',        desc:'Movimientos que curen o regeneren HP → curan el doble.' },
            'Memorex':                { tier:'Especial',  slotCategory:'Arma',      subtype:'Libro',     slot:'Arma',    img:'https://i.ibb.co/Pv79cKC8/Gemini-Generated-Image-q5xxh5q5xxh5q5xx.png',   effect:'memorex_gold_bonus', desc:'Al final de la partida, si el portador sobrevivió, multiplica el oro de recompensa ×1.5.' },
            'Nullum':                 { tier:'Especial',  slotCategory:'Arma',      subtype:'Hacha',     slot:'Arma',    img:'https://i.ibb.co/m5bGhN88/Gemini-Generated-Image-mjblsjmjblsjmjbl.png',   effect:'special_drain_50',   desc:'Ataque especial → objetivo pierde 50% de sus cargas.' },
            'Espada del Triunfo':     { tier:'Raro',      slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/tpTJnBw3/Gemini-Generated-Image-wju2u8wju2u8wju2.png',   effect:'basic_dmg_50pct',    desc:'Ataque básico causa +50% daño.' },
            'Maza Ignea':             { tier:'Especial',  slotCategory:'Arma',      subtype:'Maza',      slot:'Arma',    img:'https://i.ibb.co/sph9T2ZC/Gemini-Generated-Image-tttixtttixtttixt.png',   effect:'basic_burn_2hp',     desc:'Ataque básico aplica Quemadura 2HP al objetivo.' },
            'Daga de Kaisel':         { tier:'Especial',  slotCategory:'Arma',      subtype:'Daga',      slot:'Arma',    img:'https://i.ibb.co/1tNdZynH/v2-watermarked-20299d9f.jpg',                   effect:'debuff_mirror',      desc:'Al recibir Debuff → aplica ese debuff a enemigo aleatorio y le quita 2 cargas.' },
            'Tormenta Roja':          { tier:'Especial',  slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/chhbBgMg/v2-watermarked-3f4a38bf.jpg',                   effect:'dot_retaliation',    desc:'Al perder HP por Quemadura o Veneno → 3 daño a todo el equipo enemigo.' },
            'Vortex':                 { tier:'Epico',     slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/tphxyvrS/image-f7fb9e22.png',                           effect:'vortex_pierce',  bypassEsquivaArea:true, desc:'Ignora Esquiva Área. Daño doble a enemigos con Esquiva Área.' },
            'Tabla de Elementos':     { tier:'Raro',      slotCategory:'Arma',      subtype:'Libro',     slot:'Arma',    img:'https://i.ibb.co/hJZYDq2V/image-ab1a229d.png',                           effect:'special_dmg_plus2',  desc:'Ataques especiales causan +2 daño.' },
            'Escudo Invisible':       { tier:'Raro',      slotCategory:'Arma',      subtype:'Escudo',    slot:'Escudo',  img:'https://i.ibb.co/HTk7QVHL/image-7911c489.png',                           effect:'shield_each_round',  desc:'Al inicio de cada ronda → Buff Escudo 2HP.' },
            'Skeggöx':                { tier:'Epico',     slotCategory:'Arma',      subtype:'Hacha',     slot:'Arma',    img:'https://i.ibb.co/dwjtVByZ/image-8ea3867b.png',                           effect:'taunt_extra_turn',       desc:'Al golpear enemigo con Provocación o Mega Provocación → turno adicional e ignora Prov/MegaProv el resto de la ronda.' },
            'Ballesta de Cristal':    { tier:'Raro',      slotCategory:'Arma',      subtype:'Arco',      slot:'Arco',    img:'https://i.ibb.co/hzssnGQ/image-6c6785f0.png',                           effect:'no_charge_bonus',        desc:'Al golpear enemigo sin cargas → +2 cargas.' },
            'Frostmourne':            { tier:'Legendario',slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/60ncwCBX/image-67ce0467.png',                           effect:'frostmourne',        desc:'Duplica el daño. Roba cargas = daño causado. Si enemigo muere → revive como aliado con 100% HP y 20 cargas.' },
            'Escudo de Espejo':       { tier:'Especial',  slotCategory:'Arma',      subtype:'Escudo',    slot:'Escudo',  img:'https://i.ibb.co/pDbYQ7r/image-de6624f.png',                            effect:'escudo_de_espejo',      desc:'25% de reflejar el ataque al atacante.' },
            'Varita de Saúco':        { tier:'Legendario',slotCategory:'Arma',      subtype:'Varita',    slot:'Arma',    img:'https://i.ibb.co/cKZ40jX9/image-1f459301.png',                          effect:'varita_de_sauco',    desc:'Movimientos cuestan mitad de cargas. AOE → daño doble pero -3 HP. 30% de no recibir daño y reflejarlo.' },
            'Shadowmourne':           { tier:'Legendario',slotCategory:'Arma',      subtype:'Hacha',     slot:'Arma',    img:'https://i.ibb.co/G3v2nk4w/Whats-App-Image-2026-06-19-at-12-08-09-PM.jpg', effect:'shadowmourne',    desc:'+3 daño por ataque. Por ataque: +1 contador (+1 dmg +1 carga). A 10 contadores: AOE/MT hacen daño doble.' },
            'Zenit':                  { tier:'Legendario',slotCategory:'Arma',      subtype:'Escudo',    slot:'Escudo',  img:'https://i.ibb.co/Y7f8DVSw/Gemini-Generated-Image-uzaoqbuzaoqbuzao.png',  effect:'zenit_tank',         desc:'+3 cargas al recibir golpe. Reduce 50% el daño recibido.' },
            'Espada Nichirin Negra':  { tier:'Epico',     slotCategory:'Arma',      subtype:'Espada',    slot:'Arma',    img:'https://i.ibb.co/9mGCFpQF/image-31f4293b.png',                          effect:'espada_nichirin_negra',     desc:'Aplica Quemadura Solar con ataques. Daño doble a enemigos con Quemadura Solar.' },
            'Martillo del Alba':      { tier:'Raro',      slotCategory:'Arma',      subtype:'Martillo',  slot:'Arma',    img:'https://i.ibb.co/DHGQFpg8/image-681276ff.png',                          effect:'martillo_del_alba',  desc:'Reduce 2 cargas del enemigo golpeado.' },
            'Colmillo de Vasilisco':  { tier:'Raro',      slotCategory:'Arma',      subtype:'Daga',      slot:'Arma',    img:'https://i.ibb.co/nNK2r4wh/image-68172e14.png',                          effect:'vasilisco_poison',   desc:'Ataques básicos aplican 1 stack de Veneno.' },
            'Orbe de las Sombras':    { tier:'Raro',      slotCategory:'Joya',      subtype:'Orbe',      slot:'Joya',    img:'https://i.ibb.co/7Nx04zPN/Captura-de-pantalla-2026-05-06-144145.png',    effect:'summon_hp_bonus',    desc:'Al invocar, la invocación gana +3 HP máximo.' },

            // ── EQUIPACIÓN ──
            'Alas de Mercurio':       { tier:'Raro',      slotCategory:'Equipacion', subtype:'Botas',    slot:'Botas',   img:'https://i.ibb.co/VY0CdH10/Gemini-Generated-Image-yfkzzzyfkzzzyfkz.png',  effect:'speed_plus5',        desc:'+5 velocidad.', velBonus:5 },
            'Puño de Obsidiana':      { tier:'Especial',  slotCategory:'Equipacion', subtype:'Guante',   slot:'Guante',  img:'https://i.ibb.co/mCTKTrHW/Gemini-Generated-Image-gse74sgse74sgse7.png',  effect:'basic_dmg_plus2',    desc:'Ataque básico causa +2 daño.' },
            'Vestidura Arcana':       { tier:'Legendario',slotCategory:'Equipacion', subtype:'Vestidura',slot:'Armadura',img:'https://i.ibb.co/Q3Xzn1SL/Gemini-Generated-Image-c3waquc3waquc3wa.png',  effect:'vestidura_arcana',   desc:'El daño recibido genera la misma cantidad de cargas. Al final de cada ronda recupera 30% de HP máx. Cada vez que un enemigo recibe un buff, el portador le roba 3 HP.' },
            'Garras Lacerantes':      { tier:'Raro',      slotCategory:'Equipacion', subtype:'Guante',   slot:'Guante',  img:'https://i.ibb.co/Cp9tyvCn/Gemini-Generated-Image-xd2b04xd2b04xd2b.png',  effect:'bleed_on_hit',       desc:'15% de aplicar Sangrado al atacar. Si aplica → +2 cargas.' },
            'Yelmo de Ork':           { tier:'Raro',      slotCategory:'Equipacion', subtype:'Yelmo',    slot:'Yelmo',   img:'https://i.ibb.co/FkkKch8W/v2-watermarked-32f5a869.jpg',                   effect:'hp_on_basic_hit',    desc:'+2 HP al recibir ataque básico enemigo.' },
            'Mascara de Tyrael':      { tier:'Epico',     slotCategory:'Equipacion', subtype:'Mascara',  slot:'Yelmo',   img:'https://i.ibb.co/wFm6QxCs/image-cdf242f6.png',                           effect:'tyrael_mask',        desc:'Al final de cada ronda, el portador genera 3 cargas.' },
            'Ignifugoz':              { tier:'Especial',  slotCategory:'Equipacion', subtype:'Vestidura',slot:'Armadura',img:'https://i.ibb.co/XZN4GJ80/image-a7bffce5.png',                           effect:'ignifugoz_immunity', desc:'El portador es inmune a debuffs y daño de Quemaduras.' },
            'Capa de Invisibilidad':  { tier:'Raro',      slotCategory:'Equipacion', subtype:'Capa',     slot:'Armadura',img:'https://i.ibb.co/TDMNfNsY/image-c0ca5843.png',                           effect:'capa_de_invisibilidad',      desc:'Al inicio de cada ronda, 50% de aplicar Esquivar y Sigilo.' },
            'Escamas de Kindora':     { tier:'Epico',     slotCategory:'Equipacion', subtype:'Vestidura',slot:'Armadura',img:'https://i.ibb.co/rG09GYGR/image-5fc4b067.png',                           effect:'hp_max_50pct',       desc:'HP máximo del portador aumenta 50%.', hpPctBonus:0.50 },

            // ── JOYAS ──
            'Anillo de la Vida':      { tier:'Especial',  slotCategory:'Joya',       subtype:'Anillo',   slot:'Joya',    img:'https://i.ibb.co/DPwGq3XP/Gemini-Generated-Image-i9i8oai9i8oai9i8.png',  effect:'regen_2hp_turn',     desc:'+2 HP por turno.' },
            'Arcillos del Alba':      { tier:'Raro',      slotCategory:'Joya',       subtype:'Arcillos', slot:'Joya',    img:'https://i.ibb.co/8D80f9hX/Captura-de-pantalla-2026-04-30-120759.png',     effect:'hp_spd_plus3',       desc:'+3 HP máximo y +3 velocidad.', hpBonus:3, velBonus:3 },
            'Anillo de la Verdad':    { tier:'Raro',      slotCategory:'Joya',       subtype:'Anillo',   slot:'Joya',    img:'https://i.ibb.co/0j9p3ZDM/Gemini-Generated-Image-y5zwy7y5zwy7y5zw.png',  effect:'debuff_resist_15',  desc:'15% de limpiar un debuff al recibirlo.' },
            'Brazalete Demoniaco':    { tier:'Especial',  slotCategory:'Joya',       subtype:'Brazalete',slot:'Joya',    img:'https://i.ibb.co/93TGgK4w/image-767e9daa.png',                           effect:'fear_on_hit_25',     desc:'Al recibir golpe → 25% de aplicar Miedo al atacante.' },
            'Anillo del Tiempo':      { tier:'Legendario',slotCategory:'Joya',       subtype:'Anillo',   slot:'Joya',    img:'https://i.ibb.co/4wKysxTx/image-2ccf255a.png',                           effect:'anillo_del_tiempo',       desc:'Única vez: al ser derrotado revive con 100% HP y 20 cargas. Por cada especial/over enemigo → +10 cargas y turno adicional.' },
            'Gunbai':                 { tier:'Legendario', slotCategory:'Arma',       subtype:'Abanico',  slot:'Arma',    img:'https://i.ibb.co/JWSnmZ7C/image-3a29244d.png',                            effect:'gunbai',                  desc:'Cuando un enemigo ejecuta un Over, el portador tiene un 70% de probabilidad de bloquear el daño y todos sus efectos, y reflejar ese daño +10 sobre un enemigo aleatorio. Los enemigos golpeados por el portador reciben un bloqueo de categoría aleatoria (ST/MT/AOE/SELF) durante 2 turnos.' },
            'Kama':                   { tier:'Legendario', slotCategory:'Arma',       subtype:'Guadaña',  slot:'Arma',    img:'https://i.ibb.co/Pv1mLQy0/image-383b2844.png',                            effect:'kama',                    desc:'Roba HP a un enemigo aleatorio equivalente al daño total causado por el portador en su ataque. Al inicio de su turno: paga 3 HP por cada debuff activo para limpiarlo; por cada debuff limpiado genera 4 cargas (solo si tiene HP suficiente).' },
            // ── NUEVAS RELIQUIAS LEGENDARIAS ───────────────────────────────────────────────
            'Huevo Negro de Balerion':  { tier:'Legendario', slotCategory:'Joya',       subtype:'Accesorio',slot:'Joya',    img:'https://i.ibb.co/YFvJhZP1/Gemini-Generated-Image-9zfvb29zfvb29zfv.jpg',  effect:'huevo_balerion',          desc:'Al inicio de cada ronda invoca a Balerion si no está activo. El portador es inmune al daño de quemaduras.' },
            'Anillo Único':             { tier:'Legendario', slotCategory:'Joya',       subtype:'Anillo',   slot:'Joya',    img:'https://i.ibb.co/4Z1M0WM4/Gemini-Generated-Image-2s9bl22s9bl22s9b.jpg',  effect:'anillo_unico',            desc:'Inicio de combate: +4 HP máx, +4 daño, +4 vel, cura 4 HP, +4 cargas, Escudo 4 HP. Se reactiva al inicio de cada ronda si HP ≤ 50% (acumula).' },
            'Piedra de la Resureccion': { tier:'Legendario', slotCategory:'Joya',       subtype:'Piedra',   slot:'Joya',    img:'https://i.ibb.co/7fftDwc/Gemini-Generated-Image-vu1zemvu1zemvu1z.jpg',  effect:'piedra_resurreccion',     desc:'HP no puede bajar de 1 mientras haya aliados. Si es el último vivo: revive al equipo con 5 HP, todos ejecutan Over. Al final de esa ronda el equipo aliado es eliminado.' },
            'Katana Carmesi':           { tier:'Legendario', slotCategory:'Arma',       subtype:'Espada',   slot:'Arma',    img:'https://i.ibb.co/HDKKTwMY/Gemini-Generated-Image-xiawv0xiawv0xiaw.jpg',  effect:'katana_carmesi',          desc:'Inicio de ronda: Quemadura 5 HP a todos los enemigos. Cuando un enemigo se cura, el portador lo ataca con su básico y aplica Quemadura = cantidad curada. Final de ronda: si todos los enemigos tienen Quemadura, el portador ejecuta su Over.' },
            'Mjolnir':                  { tier:'Legendario', slotCategory:'Arma',       subtype:'Martillo', slot:'Arma',    img:'https://i.ibb.co/Z6RsbHcB/image-41cc7303.png',                            effect:'mjolnir',                 desc:'+30 velocidad. Todos los ataques que causen daño se ejecutan 2 veces. Cada golpe: 50% Aturdimiento, 25% Mega Aturdimiento. +50% probabilidad de crítico.' },
            'Pendiente Potara Derecho': { tier:'Legendario', slotCategory:'Joya',       subtype:'Arcillos', slot:'Joya',    img:'https://i.ibb.co/d40Qcd4h/image-de0c7e1f.png',                            effect:'potara_derecho',          desc:'+25 velocidad. Si un aliado tiene Potara Izquierdo, ambos copian el mismo tipo de habilidad del otro. Si el mismo personaje equipa ambos Potaras, sus stats de velocidad/cargas/daño se multiplican x2.' },
            'Pendiente Potara Izquierdo':{ tier:'Legendario', slotCategory:'Joya',       subtype:'Arcillos', slot:'Joya',    img:'https://i.ibb.co/BVSD2zzZ/image-3df03cc5.png',                            effect:'potara_izquierdo',        desc:'+25% crítico. Si un aliado tiene Potara Derecho, ambos copian el mismo tipo de habilidad del otro. Si el mismo personaje equipa ambos Potaras, +25 HP máx y daño recibido -50%.' },
            'Corona de los 7 Reinos':   { tier:'Legendario', slotCategory:'Equipacion', subtype:'Yelmo',    slot:'Equip',   img:'https://i.ibb.co/wNtTNhxN/Gemini-Generated-Image-s382tcs382tcs382.jpg',  effect:'corona_7_reinos',         desc:'Las habilidades del portador cuestan 0 cargas. El portador no puede ganar turnos adicionales por efecto de habilidades pasivas, movimientos o reliquias.' },
            'Hielo':                    { tier:'Legendario', slotCategory:'Arma',       subtype:'Espada',   slot:'Arma',    img:'https://i.ibb.co/B5TJ9ZMK/Gemini-Generated-Image-7n47nd7n47nd7n47.jpg',  effect:'hielo_espada',            desc:'Con Provocación activa: inmune a debuffs. Ataques: +1 HP máx por reliquia del objetivo golpeado. Los ataques causan +5% de daño adicional basado en el HP actual del portador.' },
            'Escudo del Capitan America':{ tier:'Legendario', slotCategory:'Arma',       subtype:'Escudo',   slot:'Arma',    img:'https://i.ibb.co/B5JMy0Y2/descarga-4.jpg',                                effect:'escudo_capitan',          desc:'Mientras el portador esté vivo, absorbe todo el daño de Overs enemigos que recibiría el equipo aliado. Al recibir ese daño, contraataca con 60% HP máx. Si muere por Over, aplica Mega Aturdimiento al equipo enemigo.' },
            'Armadura de Darth Vader':  { tier:'Legendario', slotCategory:'Equipacion', subtype:'Armadura', slot:'Equip',   img:'https://i.ibb.co/4bYLtyH/descarga-6.jpg',                                effect:'armadura_vader',          desc:'Inmune a Miedo, Congelación, Aturdimiento, Confusión, Ceguera y Posesión. -20 velocidad. Final de ronda: ataca a un enemigo aleatorio por la diferencia de velocidad; si lo mata, gana ese valor en HP máx.' },
            'Sable de Luz Amatista':    { tier:'Legendario', slotCategory:'Arma',       subtype:'Espada',   slot:'Arma',    img:'https://i.ibb.co/nNyTV1vq/Gemini-Generated-Image-zi5s21zi5s21zi5s.jpg',  effect:'sable_amatista',          desc:'Golpes MT aplican Marca Amatista al objetivo. Por cada marca: +50% daño MT. Los ataques del portador roban cargas del objetivo iguales al daño causado.' },
            'Armadura de Hades':        { tier:'Legendario', slotCategory:'Equipacion', subtype:'Armadura', slot:'Equip',   img:'https://i.ibb.co/V0JQ6Qgx/image-125f72e8.png',                            effect:'armadura_hades',          desc:'Cada ataque recibido genera 1 contador del inframundo. Por contador: +10% daño causado, -10% daño recibido. Al llegar a 8: elimina un enemigo aleatorio y resetea contadores.' },
            // ══ RELIQUIAS EXCLUSIVAS DE LA HORDA DE ELFOS OSCUROS ══════════════════════════
            // Raras
            'Maza Necrotica':            { tier:'Raro',      slotCategory:'Arma',       subtype:'Maza',      slot:'Arma',   img:'https://i.ibb.co/R4MMW2qV/image-6ee2fae1.png', effect:'elfr_maza_necrotica',      desc:'Los movimientos del portador que roban HP roban un 50% más. Genera 1 carga cada vez que el portador ejecuta un movimiento.' },
            'Cuchillas de Depredador':   { tier:'Raro',      slotCategory:'Equipacion', subtype:'Guante',    slot:'Equip',  img:'https://i.ibb.co/QFk7Wvzn/Gemini-Generated-Image-3i19xv3i19xv3i19.jpg', effect:'elfr_cuchillas_depredador', desc:'+10% de probabilidad de golpe crítico. Cada crítico acertado aumenta ese bono en +10% de forma acumulativa.' },
            'Armadura de Hueso':         { tier:'Raro',      slotCategory:'Equipacion', subtype:'Armadura',  slot:'Equip',  img:'https://i.ibb.co/tPBqJCs6/Gemini-Generated-Image-n345xgn345xgn345.jpg', effect:'elfr_armadura_hueso',     desc:'Cada ataque recibido aplica Sangrado al atacante. Si el atacante tiene Hemorragia, elimina 5 cargas de todos los enemigos.' },
            'Espiritu de Nandi':         { tier:'Raro',      slotCategory:'Equipacion', subtype:'Hombreras', slot:'Equip',  img:'https://i.ibb.co/n85B83gz/Gemini-Generated-Image-5n2c7s5n2c7s5n2c.jpg', effect:'elfr_espiritu_nandi',     desc:'Cada vez que un aliado recibe daño, el portador se cura el 30% de ese daño.' },
            'Minutero Zafkiel':          { tier:'Raro',      slotCategory:'Arma',       subtype:'Mosquete',  slot:'Arma',   img:'https://i.ibb.co/1G8ZTLFw/Gemini-Generated-Image-oi28z1oi28z1oi28-1.jpg', effect:'elfr_minutero_zafkiel',   desc:'Reduce -3 la velocidad del objetivo golpeado. Contra enemigos más lentos: crítico garantizado y 10% de daño triple.' },
            'Brazalete Ferndur':         { tier:'Raro',      slotCategory:'Equipacion', subtype:'Brazalete', slot:'Equip',  img:'https://i.ibb.co/ycvhq4JY/Gemini-Generated-Image-6b7bjv6b7bjv6b7b.jpg', effect:'elfr_brazalete_ferndur',  desc:'El portador no puede recibir daño de ataques MT. Si recibe daño por un AOE, gana Escudo de 5 HP.' },
            'Nekrovus':                  { tier:'Raro',      slotCategory:'Joya',       subtype:'Pergamino', slot:'Joya',   img:'https://i.ibb.co/6R010ts0/Gemini-Generated-Image-pkdohgpkdohgpkdo.jpg', effect:'elfr_nekrovus',           desc:'Al final de cada ronda, 50% de robar 1 HP y 1 carga de cada enemigo. Con menos del 50% de HP, la cantidad robada se duplica.' },
            'Cinturon Arcano':           { tier:'Raro',      slotCategory:'Equipacion', subtype:'Cinto',     slot:'Equip',  img:'https://i.ibb.co/tMPt80LQ/Gemini-Generated-Image-v4xtdcv4xtdcv4xt.jpg', effect:'elfr_cinturon_arcano',    desc:'Cada vez que un aliado (no el portador) gasta cargas para ejecutar un movimiento, el portador genera 3 cargas.' },
            'Garra del Rey Lobo':        { tier:'Raro',      slotCategory:'Equipacion', subtype:'Guante',    slot:'Equip',  img:'https://i.ibb.co/pvDmMn7k/Gemini-Generated-Image-9tvhp29tvhp29tvh.jpg', effect:'elfr_garra_rey_lobo',     desc:'Contra enemigos con debuff activo causa daño doble y cura 5 HP al portador por cada debuff del objetivo.' },
            'Talisman de Harvart':       { tier:'Raro',      slotCategory:'Joya',       subtype:'Talisman',  slot:'Joya',   img:'https://i.ibb.co/84b46B1H/Gemini-Generated-Image-2nhqgh2nhqgh2nhq.jpg', effect:'elfr_talisman_harvart',   desc:'Cada vez que un enemigo ejecuta un Over, el portador gana Esquivar 1 turno y Armadura 1 turno.' },
            // Especiales
            'Nebularis':                 { tier:'Especial',  slotCategory:'Joya',       subtype:'Collar',    slot:'Joya',   img:'https://i.ibb.co/cXK8wXrL/image-a5a6642e.png', effect:'elfr_nebularis',          desc:'Cada vez que el portador recibe un debuff, limpia un debuff aleatorio de un aliado. Por cada debuff limpiado gana Escudo de 4 HP.' },
            'Gema de Vitalidad':         { tier:'Especial',  slotCategory:'Joya',       subtype:'Gema',      slot:'Joya',   img:'https://i.ibb.co/Dg9Cn1Qt/Gemini-Generated-Image-qdkrapqdkrapqdkr.jpg', effect:'elfr_gema_vitalidad',     desc:'Cada vez que el portador recibe daño cura 2 HP a todos los aliados. Si muere, cura el 50% del HP máx de todos los aliados y disipa sus debuffs.' },
            'Mangual de Ophiuchus':      { tier:'Especial',  slotCategory:'Arma',       subtype:'Mangual',   slot:'Arma',   img:'https://i.ibb.co/hFZFrdpD/Gemini-Generated-Image-d6umy8d6umy8d6um.jpg', effect:'elfr_mangual_ophiuchus',  desc:'Si un enemigo recibe daño de veneno, el portador ejecuta un AOE suyo al azar (máx. 3 por ronda). Sus ataques aplican de 1 a 3 stacks de Veneno.' },
            'Markas de Sigurd':          { tier:'Especial',  slotCategory:'Equipacion', subtype:'Botas',     slot:'Equip',  img:'https://i.ibb.co/xq3RZ3dS/Gemini-Generated-Image-ut6uqut6uqut6uqu.jpg', effect:'elfr_markas_sigurd',      desc:'Cada vez que un enemigo gana 1 turno adicional, el portador gana 1 turno adicional y +5 de velocidad.' },
            'Pistola de Chispa Zafkei':  { tier:'Especial',  slotCategory:'Arma',       subtype:'Pistola',   slot:'Arma',   img:'https://i.ibb.co/zVQwqjyF/image-80f9d61c.png', effect:'elfr_pistola_zafkei',     desc:'Al inicio de la partida ejecuta 3 veces su básico ST sobre enemigos aleatorios. Los enemigos golpeados por el portador pierden -5 de velocidad.' },
            'Capucha del Asesino de la noche': { tier:'Especial', slotCategory:'Equipacion', subtype:'Yelmo', slot:'Equip', img:'https://i.ibb.co/cXFMrxq5/Gemini-Generated-Image-ncq2mwncq2mwncq2.jpg', effect:'elfr_capucha_asesino',  desc:'Ignora Provocación y Mega Provocación enemigas. Al final de cada ronda limpia 1 debuff del portador.' },
            'Abanico de Acero':          { tier:'Especial',  slotCategory:'Arma',       subtype:'Abanico',   slot:'Arma',   img:'https://i.ibb.co/ksKdJ0nN/Gemini-Generated-Image-ws961nws961nws96.jpg', effect:'elfr_abanico_acero',      desc:'Cuando el portador recibe un debuff, limpia 1 debuff de cada aliado. Por cada debuff limpiado, +1 al daño base de sus ataques AOE.' },
            'Drafuriz':                  { tier:'Especial',  slotCategory:'Equipacion', subtype:'Armadura',  slot:'Equip',  img:'https://i.ibb.co/Kx56TFRV/Gemini-Generated-Image-ybzj5jybzj5jybzj.jpg', effect:'elfr_drafuriz',           desc:'Cada vez que un enemigo gasta cargas, el portador se aplica Quemadura 2 HP. El daño por Quemadura lo cura en vez de dañarlo.' },
            'Capa Namekiana':            { tier:'Especial',  slotCategory:'Equipacion', subtype:'Capa',      slot:'Equip',  img:'https://i.ibb.co/fzYb3N7Z/Gemini-Generated-Image-kjdayrkjdayrkjda.jpg', effect:'elfr_capa_namekiana',     desc:'Al ser eliminado genera 10 cargas a todos los aliados. No puede recibir debuffs mientras tenga al menos 1 buff activo.' },
            'Azote del Invierno':        { tier:'Especial',  slotCategory:'Arma',       subtype:'Maza',      slot:'Arma',   img:'https://i.ibb.co/6R2Xyq0b/Gemini-Generated-Image-mkkg9amkkg9amkkg.jpg', effect:'elfr_azote_invierno',     desc:'Sus AOE tienen 50% de aplicar Congelación. Contra enemigos que ya estaban congelados, roba 5 HP.' },
            // Épicas
            'Capa del Rey Hungaro':      { tier:'Epico',     slotCategory:'Equipacion', subtype:'Capa',      slot:'Equip',  img:'https://i.ibb.co/Z1ckCmjf/Gemini-Generated-Image-fasvwefasvwefasv.jpg', effect:'elfr_capa_hungaro',       desc:'Al recibir daño acumula una Marca del Rey Húngaro. Por cada marca recupera 3 HP al recibir daño y causa +10% de daño con sus ataques.' },
            'Mascara de Nigromante':     { tier:'Epico',     slotCategory:'Equipacion', subtype:'Yelmo',     slot:'Equip',  img:'https://i.ibb.co/dsKwzybk/Gemini-Generated-Image-prdijcprdijcprdi.jpg', effect:'elfr_mascara_nigromante', desc:'Al inicio de cada ronda invoca 2 Esqueletos. El daño que reciben los Esqueletos cura al portador; si está al máximo de HP, lo convierte en daño a un enemigo aleatorio.' },
            'Escudo Arcantos':           { tier:'Epico',     slotCategory:'Arma',       subtype:'Escudo',    slot:'Arma',   img:'https://i.ibb.co/PsqJYkm5/Gemini-Generated-Image-27jzz927jzz927jz.jpg', effect:'elfr_escudo_arcantos',    desc:'Empieza con 1 contador Arcantos y añade 1 a un enemigo al inicio de cada ronda. El daño al portador se divide entre todos los contadores activos y cada personaje recibe la parte proporcional.' },
            'Piedra del Sol':            { tier:'Epico',     slotCategory:'Joya',       subtype:'Piedra',    slot:'Joya',   img:'https://i.ibb.co/r2J6BtzK/Gemini-Generated-Image-xqfr4dxqfr4dxqfr.jpg', effect:'elfr_piedra_sol',         desc:'Inmune a Ceguera y Confusión. Cuando el portador ejecuta un Over, todos los aliados disipan sus debuffs y generan 5 cargas.' },
            'Karuka':                    { tier:'Epico',     slotCategory:'Arma',       subtype:'Escudo',    slot:'Arma',   img:'https://i.ibb.co/9my0PvyW/Gemini-Generated-Image-93k19993k19993k1.jpg', effect:'elfr_karuka',             desc:'Reduce un 25% el daño recibido por cada buff activo del portador. Inmune a Aturdimiento y Mega Aturdimiento.' },
            'Cadena Tasokidan':          { tier:'Epico',     slotCategory:'Arma',       subtype:'Cadena',    slot:'Arma',   img:'https://i.ibb.co/q3hk9SbW/Gemini-Generated-Image-idrgznidrgznidrg.jpg', effect:'elfr_cadena_tasokidan',   desc:'Cada golpe del portador aplica una marca Tasokidan. Cuando el portador causa daño, los enemigos marcados reciben un 10% de ese daño por cada marca activa.' },
            'Grebas Oscuras':            { tier:'Epico',     slotCategory:'Equipacion', subtype:'Grebas',    slot:'Equip',  img:'https://i.ibb.co/K3YMYnM/Gemini-Generated-Image-9t1mcl9t1mcl9t1m.jpg', effect:'elfr_grebas_oscuras',     desc:'+15 HP máx. Al final de cada ronda, si tiene el 20% o menos de su HP máx, gana un Escudo igual al 20% de su HP máx.' },
            'Sable de Luz de Obi-Wan':   { tier:'Epico',     slotCategory:'Arma',       subtype:'Espada',    slot:'Arma',   img:'https://i.ibb.co/DDp2xbnQ/Gemini-Generated-Image-vom5hgvom5hgvom5.jpg', effect:'elfr_sable_obiwan',       desc:'Cada golpe genera Escudo igual al 10% del HP máx del enemigo golpeado (acumulable). Cada vez que fuera a recibir un debuff, sacrifica 10 HP de Escudo para limpiarlo (solo si tiene ≥10 de Escudo). +2% de daño por cada punto de Escudo activo.' },
            'Corona de los no muertos':  { tier:'Epico',     slotCategory:'Equipacion', subtype:'Yelmo',     slot:'Equip',  img:'https://i.ibb.co/ksP2ZxXg/Gemini-Generated-Image-rcnfmcrcnfmcrcnf.jpg', effect:'elfr_corona_no_muertos',  desc:'Recibe un 75% menos de daño por golpe de enemigos con menos HP actual que el portador (se aplica después de cualquier otra reducción). Al tomar turno se cura el 10% del HP actual del enemigo con más HP.' },
            'Espadas del Caos':          { tier:'Epico',     slotCategory:'Arma',       subtype:'Espada',    slot:'Arma',   img:'https://i.ibb.co/RGv0GXvr/Gemini-Generated-Image-3sjsry3sjsry3sjs.jpg', effect:'elfr_espadas_caos',       desc:'Cada golpe crítico genera 1 Contador del Caos en el portador. Por cada Contador del Caos, el portador gana +2 de daño base en todos sus movimientos (acumulable, se reinicia al iniciar partida). Cada vez que cualquier Sangrado en cualquier enemigo se transforma en Hemorragia, el portador gana +5 HP máx.' },
            'Palantir':               { tier:'Epico',     slotCategory:'Joya',       subtype:'Orbe',     slot:'Joya',    img:'https://i.ibb.co/9mYGrfWT/image-38dcb910.png',                           effect:'palantir',    bypassMegaProvocacion:true, desc:'Ignora Provocación, Mega Provocación y Sigilo. Aplica Posesión a los objetivos.' },
            'Ojo de Serpiente':       { tier:'Especial',  slotCategory:'Joya',       subtype:'Orbe',     slot:'Joya',    img:'https://i.ibb.co/bjrdDzBF/image-ba09b3a0.png',                           effect:'ojo_de_serpiente',   desc:'Si objetivo golpeado tiene stacks de Veneno activo → aplica misma cantidad a todos los demás enemigos.' },
            'Ojo de Gorgona':         { tier:'Epico',     slotCategory:'Joya',       subtype:'Orbe',     slot:'Joya',    img:'https://i.ibb.co/rKvN3qL2/image-dd06954e.png',                           effect:'ojo_de_gorgona',    desc:'Daño ST sobre enemigo → cura HP a todos los aliados = mitad del daño causado.' },
            'Dije de Athelstan':      { tier:'Especial',  slotCategory:'Joya',       subtype:'Dije',     slot:'Joya',    img:'https://i.ibb.co/xtWJ962j/image-730174c9.png',                           effect:'athelstan_regen',    desc:'Al inicio de cada ronda: +1 HP y +1 carga.' },
            'Huevo de Dragon':        { tier:'Epico',     slotCategory:'Joya',       subtype:'Orbe',     slot:'Joya',    img:'https://i.ibb.co/KjXsH05q/image.png',                                   effect:'dragon_egg_summon',  desc:'Las invocaciones del portador ganan Esquiva Área.' },
            'Zaifer':                 { tier:'Raro',      slotCategory:'Joya',       subtype:'Collar',   slot:'Joya',    img:'https://i.ibb.co/cSZ2dfsS/image-6bbe4f2a.png',                          effect:'zaifer_speed',       desc:'Al final de cada ronda incrementa en +1 la velocidad del portador.' },
            'Alabarda del Sol':       { tier:'Especial',  slotCategory:'Arma',       subtype:'Alabarda', slot:'Arma',    img:'https://i.ibb.co/kgb5D5Rm/image-c38607f5.png',                          effect:'alabarda_del_sol',   desc:'Si el objetivo golpeado tiene debuff Quemaduras o Quemadura Solar, el portador genera 8 cargas.' },
            'Faja de la Agonia':      { tier:'Epico',     slotCategory:'Equipacion', subtype:'Cinto',    slot:'Cinto',   img:'https://i.ibb.co/xS8Fcv44/image-735c8dd3.png',                          effect:'faja_de_la_agonia',  desc:'Al final de cada ronda el portador pierde 2 HP. Cada vez que un enemigo genera cargas, el portador genera 2 cargas.' },
            'Anima Vorax':            { tier:'Legendario',slotCategory:'Arma',       subtype:'Guadaña',  slot:'Arma',    img:'https://i.ibb.co/tMKNdk6T/Gemini-Generated-Image-5qdp15qdp15qdp15.png', effect:'anima_vorax',        desc:'Cada vez que el portador causa daño, activa todas las pasivas de sus invocaciones. Cada vez que una invocación del portador es eliminada, el portador drena 5 cargas de todos los enemigos.' },
            'Armadura de Crixo':      { tier:'Raro',      slotCategory:'Equipacion', subtype:'Armadura', slot:'Armadura',img:'https://i.ibb.co/ZRbN6K3J/image-c284bfe6.png',                          effect:'armadura_de_crixo',  desc:'Al recibir un golpe enemigo, aplica Ceguera 2 turnos sobre ese enemigo y el portador gana +5 velocidad hasta el final de la próxima ronda.' },
            'Fortaleza del Guardian': { tier:'Especial',  slotCategory:'Equipacion', subtype:'Hombreras',slot:'Hombreras',img:'https://i.ibb.co/LXNFbmVk/image.png',                                  effect:'fortaleza_guardian', desc:'Si el portador ejecuta un Over, recupera 5 HP y se aplica Buff Protección Sagrada 2 turnos.' },
            ...
            // ── NUEVAS RELIQUIAS ────────────────────────────────────────────────
            'Uniforme de Cazademonios': { tier:'Raro',     slotCategory:'Equipacion', subtype:'Vestidura', slot:'Armadura', img:'https://i.ibb.co/r2wLDXWQ/image-c2b7130f.png', effect:'uniforme_cazademonios', desc:'El portador gana efecto pasivo Anticipación.' },
            'Haori de Roca':           { tier:'Especial',  slotCategory:'Equipacion', subtype:'Capa',      slot:'Armadura', img:'https://i.ibb.co/Q7tcww34/image-7748b2f0.png', effect:'haori_roca',            desc:'Aplica Provocación al portador. Aplica Anticipación al portador.' },
            'Vacuna de Glicinia':      { tier:'Especial',  slotCategory:'Joya',       subtype:'Accesorio', slot:'Joya',     img:'https://i.ibb.co/wNLsCdXH/image-fff7820a.png', effect:'vacuna_glicinia',       desc:'Al inicio de cada ronda, disipa los debuffs del portador y de un aliado aleatorio.' },
            'Cadena de Gyomei':        { tier:'Epico',     slotCategory:'Joya',       subtype:'Collar',    slot:'Joya',     img:'https://i.ibb.co/dJKX4ZNj/image-dae8cdea.png',           effect:'cadena_gyomei',         desc:'Cuando el portador recibe daño, gana Escudo HP igual a la cantidad de daño recibido.' },
            'Sangre de Sanemi':        { tier:'Epico',     slotCategory:'Joya',       subtype:'Accesorio', slot:'Joya',     img:'https://i.ibb.co/PqJYqQQ/image.png',            effect:'sangre_sanemi',         desc:'Al recibir un golpe aplica Confusión al atacante. 25% de probabilidad de aplicar Aturdimiento a cada enemigo.' },
            'Onslaught':               { tier:'Epico',     slotCategory:'Joya',       subtype:'Anillo',    slot:'Joya',     img:'https://i.ibb.co/d3mjqXN/Gemini-Generated-Image-sntka3sntka3sntk.png', effect:'onslaught', desc:'30% de probabilidad de golpe crítico. Cada crítico aumenta +2 la velocidad del portador.' },
            'Fulgor Argénteo':         { tier:'Raro',      slotCategory:'Equipacion', subtype:'Armadura',  slot:'Armadura', img:'https://i.ibb.co/7Nvzf1cF/Gemini-Generated-Image-4aq2hz4aq2hz4aq2.png', effect:'fulgor_argenteo', desc:'Al inicio de cada ronda el portador tiene 50% de probabilidad de ganar buff Protección Sagrada 2 turnos (inmune a debuffs).' },
            'Filo del Abismo':         { tier:'Especial',  slotCategory:'Arma',       subtype:'Hacha',     slot:'Arma',     img:'https://i.ibb.co/4g4jY3L9/Gemini-Generated-Image-rg5385rg5385rg53.png', effect:'filo_abismo', desc:'Los ataques AOE del portador causan +5 de daño adicional en enemigos con buffs activos.' },
            'Talismán de Hermes':      { tier:'Especial',  slotCategory:'Joya',       subtype:'Collar',    slot:'Joya',     img:'https://i.ibb.co/7NVDG7ZP/Gemini-Generated-Image-76sde176sde176sd.png', effect:'talisman_hermes', desc:'Al inicio de la partida el equipo aliado gana +3 de velocidad. Cada vez que un enemigo muere, todo el equipo aliado gana +1 de velocidad.' },
            'Arco del Kitan':          { tier:'Epico',     slotCategory:'Arma',       subtype:'Arco',      slot:'Arma',     img:'https://i.ibb.co/Xf7CLFZH/Gemini-Generated-Image-ecjszgecjszgecjs.png', effect:'arco_kitan', desc:'Cada vez que un debuff del equipo enemigo es limpiado, el daño base del básico del portador incrementa +1 (permanente). Una vez por ronda, cuando un enemigo recibe un buff, el portador ejecuta su ataque básico sobre ese enemigo.' },
            'Fragmento de la Luz':     { tier:'Raro',      slotCategory:'Joya',       subtype:'Fragmento', slot:'Joya',     img:'https://i.ibb.co/RkmQYZdf/image.png',           effect:'fragmento_luz',         desc:'Cada vez que un enemigo se cura, aplica un Escudo de 2 HP en todos los aliados.' },
            ...
            'Tanque de Bacta':        { tier:'Especial',  slotCategory:'Joya',       subtype:'Reliquia',   slot:'Joya',       img:'https://i.ibb.co/ZzjDy5NQ/image-4e29a61d.png',      effect:'tanque_bacta',         desc:'El portador gana el efecto pasivo Cuerpo Perfecto (al fin de cada ronda elimina sus debuffs activos).' },
            'Cristal Kyber':          { tier:'Epico',     slotCategory:'Joya',       subtype:'Reliquia',   slot:'Joya',       img:'https://i.ibb.co/yFSWggJf/image-fc6fe2ed.png',      effect:'cristal_kyber',        desc:'Cuando el portador ejecuta un Over ST, causa el mismo daño al objetivo en un enemigo aleatorio.' },
            'Capa Élfica de Rivendell':{ tier:'Raro',     slotCategory:'Equipacion', subtype:'Capa',       slot:'Armadura',   img:'https://i.ibb.co/Jw22Dt0z/image-775ca018.png',      effect:'capa_elfica',          desc:'Los ataques del portador tienen 25% de probabilidad de aplicar Congelación al objetivo.' },
            'Anillo de Piedra de Moria':{ tier:'Raro',    slotCategory:'Joya',       subtype:'Anillo',     slot:'Joya',       img:'https://i.ibb.co/chWF3QkK/image-61f4174f.png',      effect:'anillo_moria',         desc:'Cada vez que el portador recibe un debuff, genera 2 cargas.' },
            'Cuerno de Gondor':       { tier:'Especial',  slotCategory:'Joya',       subtype:'Accesorio',  slot:'Joya',       img:'https://i.ibb.co/qYP3ZgXY/image-60c03f7a.png',      effect:'cuerno_gondor',        desc:'Al inicio de cada ronda cada aliado tiene 40% de probabilidad de recibir buff Asistir.' },
            'Estandarte de Rohan':    { tier:'Especial',  slotCategory:'Joya',       subtype:'Accesorio',  slot:'Joya',       img:'https://i.ibb.co/JRqxNR2V/image-1204712f.png',      effect:'estandarte_rohan',     desc:'Al inicio de cada ronda, 40% de probabilidad de aplicar buff Contraataque a cada aliado aleatorio.' },
            'Pechera de Mitril':      { tier:'Epico',     slotCategory:'Equipacion', subtype:'Armadura',   slot:'Armadura',   img:'https://i.ibb.co/KjSZjckf/image-f368e456.png',      effect:'pechera_mitril',       desc:'El portador no puede ser eliminado por efectos directos de pasivas o movimientos. Si fuera a recibir 5 o más de daño por un ataque, 50% de probabilidad de no recibir ese daño.' },
            'Muñequeras de Goku':     { tier:'Raro',      slotCategory:'Equipacion', subtype:'Brazaletes', slot:'Brazaletes', img:'https://i.ibb.co/tTn3XcSR/image-88e98145.png',      effect:'munequeras_goku',      desc:'30% de probabilidad de ganar 1 turno adicional después de realizar un ataque MT.' },
            'Semillas Senzu':         { tier:'Raro',      slotCategory:'Joya',       subtype:'Accesorio',  slot:'Joya',       img:'https://i.ibb.co/N267tmyF/image-77d4bd1c.png',      effect:'semillas_senzu',       desc:'Al inicio de cada ronda cura 3 HP al aliado con menos HP del equipo.' },
            'Radar del Dragón':       { tier:'Raro',      slotCategory:'Joya',       subtype:'Reliquia',   slot:'Joya',       img:'https://i.ibb.co/GNgD2CJ/image-6b4136e1.png',       effect:'radar_dragon',         desc:'Al inicio de la partida y al inicio de cada ronda, realiza 1 invocación aleatoria de las que el portador puede invocar con su pasiva (si aplica).' },
            'Rastreador':             { tier:'Especial',  slotCategory:'Equipacion', subtype:'Lente',      slot:'Yelmo',      img:'https://i.ibb.co/0RLfM1KS/image-c1fbabe1.png',      effect:'rastreador',           desc:'El portador gana los efectos pasivos Anticipación y Contraataque.' },
            'Armadura Saiyan':        { tier:'Epico',     slotCategory:'Equipacion', subtype:'Armadura',   slot:'Armadura',   img:'https://i.ibb.co/4gsJJVJN/image-48295a19.png',       effect:'armadura_saiyan',      desc:'El portador incrementa +10 de velocidad y gana el efecto pasivo Armadura (reduce 50% el daño recibido).' },
            'Traje de Saiyaman':      { tier:'Epico',     slotCategory:'Equipacion', subtype:'Vestidura',  slot:'Armadura',   img:'https://i.ibb.co/3mSv3SY4/image-9623103c.png',      effect:'traje_saiyaman',       desc:'Cada vez que el portador recibe daño, disipa sus debuffs activos. Cada vez que el portador causa daño sobre un enemigo, aplica Confusión a un enemigo aleatorio.' },
            'Aretes Hanafuda':        { tier:'Raro',      slotCategory:'Joya',       subtype:'Aretes',     slot:'Joya',       img:'https://i.ibb.co/vxPsyS6J/image-ca9ab32d.png',      effect:'aretes_hanafuda',      desc:'Cada vez que el portador aplica Quemadura Solar a un enemigo, genera 2 cargas.' },
            'Cápsula de Glicinia':    { tier:'Raro',      slotCategory:'Joya',       subtype:'Accesorio',  slot:'Joya',       img:'https://i.ibb.co/wZ3YrgBD/image-1b3eec33.png',      effect:'capsula_glicinia',     desc:'El portador se cura 2 HP por cada debuff limpiado o disipado en el equipo aliado.' },
            'Direbounds':             { tier:'Legendario',slotCategory:'Equipacion', subtype:'Guante',   slot:'Guante',  img:'https://i.ibb.co/4nLybhhw/image-501ad0ff.png',                          effect:'direbounds',         desc:'Cada vez que un aliado o enemigo es eliminado, el portador gana 1 turno adicional y genera 15 cargas. +5 al daño base de todos los movimientos ST del portador. El portador solo puede tener 1 debuff activo a la vez.' },

            'Ashbringer':             { tier:'Legendario',slotCategory:'Arma',       subtype:'Espada',   slot:'Arma',    img:'https://i.ibb.co/zhkmP5X2/Card-Name-Ashbringer-Artist-Thomas-Tenery.jpg', effect:'ashbringer', desc:'Se cura 40% de su HP máx al final de cada ronda. Las curaciones que reciba se replican en 2 aliados aleatorios. Al curar/aplicar buff/generar cargas en un aliado (no en sí mismo), disipa todos los debuffs aliados y buffs enemigos — +1 HP máx por cada uno disipado.' },
            'Rompecabezas del Milenio': { tier:'Legendario',slotCategory:'Joya',     subtype:'Collar',   slot:'Joya',    img:'https://i.ibb.co/Z3KV3Y7/descarga-1.jpg',                               effect:'rompecabezas_milenio', desc:'Al ejecutar cualquier movimiento, 80% de probabilidad de ejecutar su movimiento de Transformación (si el personaje tiene uno). 50% de probabilidad de ganar 1 turno adicional cada vez que un enemigo ejecuta una habilidad.' },
            'Collar de Tsunade':      { tier:'Raro',      slotCategory:'Joya',       subtype:'Collar',   slot:'Joya',    img:'https://i.ibb.co/MxpHGcLr/Gemini-Generated-Image-n9eu36n9eu36n9eu.jpg', effect:'collar_tsunade', desc:'Una vez por combate, si el portador llega a 0 HP, restaura 40% de su HP en lugar de ser eliminado.' },
            'Cristal de Mana Concentrado': { tier:'Raro', slotCategory:'Joya',       subtype:'Accesorio',slot:'Joya',    img:'https://i.ibb.co/39C6m5vR/Gemini-Generated-Image-vjsbkwvjsbkwvjsb.jpg', effect:'cristal_mana', desc:'Al final de cada ronda, el portador y un aliado aleatorio ganan +1 velocidad y generan 1 carga.' },
            'Armadura de Bronce':     { tier:'Raro',      slotCategory:'Equipacion', subtype:'Armadura', slot:'Armadura',img:'https://i.ibb.co/5xKphX9T/Gemini-Generated-Image-nojtnhnojtnhnojt.jpg', effect:'armadura_bronce', desc:'Cada vez que el portador recibe un ataque, aumenta +1 su HP máximo.' },
            'Estandarte de Juana de Arco': { tier:'Raro', slotCategory:'Joya',       subtype:'Accesorio',slot:'Joya',    img:'https://i.ibb.co/vC5Fs2bt/Gemini-Generated-Image-fde4gdfde4gdfde4.jpg', effect:'estandarte_juana', desc:'+2 velocidad a todo el equipo aliado. Al final de cada ronda, otorga Celeridad 10% (1 turno) a un aliado aleatorio.' },
            'Llave Negra de Kirei':   { tier:'Raro',      slotCategory:'Arma',       subtype:'Espada',   slot:'Arma',    img:'https://i.ibb.co/0jsCXFPY/Gemini-Generated-Image-ppfvryppfvryppfv.jpg', effect:'llave_kirei', desc:'Al ejecutar un ataque especial, limpia 1 buff activo de cada enemigo golpeado.' },
            'Granadas de Uzui':       { tier:'Raro',      slotCategory:'Joya',       subtype:'Accesorio',slot:'Joya',    img:'https://i.ibb.co/LX3SQNpf/Gemini-Generated-Image-syjewbsyjewbsyje.jpg', effect:'granadas_uzui', desc:'Al inicio de cada ronda, 50% de probabilidad de aplicar Quemaduras (2 HP) a cada enemigo.' },
            'Espada de Acero Valyrio': { tier:'Especial', slotCategory:'Arma',       subtype:'Espada',   slot:'Arma',    img:'https://i.ibb.co/nMwvs8P2/image-1b4f6cde.png',                          effect:'espada_valyrio', desc:'El Over ST del portador tiene 1% de probabilidad de eliminar al objetivo. Al final de cada ronda, 30% de probabilidad de +2 velocidad a cada aliado.' },
            'Guantes de Pantera Negra': { tier:'Especial', slotCategory:'Equipacion', subtype:'Guantes', slot:'Guantes', img:'https://i.ibb.co/93qL2mLK/Whats-App-Image-2026-08-13-at-1-54-27-PM.jpg', effect:'guantes_pantera', desc:'+3 de daño en todas las habilidades ST del portador.' },
            'Guante de Scorpio':        { tier:'Legendario', slotCategory:'Equipacion', subtype:'Guante', slot:'Guante', img:'https://i.ibb.co/jkZbsp1H/Whats-App-Image-2026-08-20-at-5-10-00-PM.jpg', effect:'guante_scorpio', desc:'Todos los ataques del portador aplican de 1 a 5 stacks de Veneno por cada golpe acertado sobre el objetivo. Si un enemigo ejecuta un ataque AOE o MT, aplica de 1 a 15 stacks aleatorias de Veneno a ese enemigo. Cualquier daño causado por un Over de un enemigo con Veneno activo se reduce a 0.' },
            'Hacha de Floki':         { tier:'Especial',  slotCategory:'Arma',       subtype:'Hacha',    slot:'Arma',    img:'https://i.ibb.co/hJj1BYsF/image-f2ea334.png',                           effect:'hacha_floki', desc:'Los ataques del portador aplican 1 stack de Veneno. Si el enemigo ya tenía Veneno, aplica Ponzoña en su lugar.' },
            'Arco de Atila':          { tier:'Especial',  slotCategory:'Arma',       subtype:'Arco',     slot:'Arma',    img:'https://i.ibb.co/0RG1tzpY/image-fa4364d.png',                           effect:'arco_atila', desc:'Los ataques del portador aplican Ceguera 2 turnos. Cada vez que un enemigo recibe curación, el portador ejecuta su básico sobre ese enemigo (solo si es ST).' },
            'Armadura Dorada Fragmentada': { tier:'Especial', slotCategory:'Equipacion', subtype:'Armadura', slot:'Armadura', img:'https://i.ibb.co/9H7yyjKr/image-6a464448.png', effect:'armadura_dorada_frag', hpBonus:10, desc:'+10 HP máximo. Al inicio de cada ronda, el portador se aplica Regeneración 10% (1 turno).' },
            'Hilos de Chakra de Sasori': { tier:'Especial', slotCategory:'Joya',     subtype:'Accesorio',slot:'Joya',    img:'https://i.ibb.co/5WWz2Cx0/image-cac8cc5f.png',                          effect:'hilos_sasori', desc:'Los ataques del portador aplican Posesión. Cuando un enemigo gana un turno adicional, 30% de probabilidad de aplicar Mega Posesión sobre él.' },
            'Yelmo de Caballero de la Muerte': { tier:'Especial', slotCategory:'Equipacion', subtype:'Yelmo', slot:'Yelmo', img:'https://i.ibb.co/SwDL2KF9/image-6b8d35c5.png', effect:'yelmo_caballero_muerte', desc:'Cuando se aplica Congelación a un enemigo, el portador ejecuta su básico sobre él (solo si es ST). Si se aplica Megacongelación, lo ejecuta 3 veces.' },
            'Katana del Rayo':        { tier:'Epico',      slotCategory:'Arma',       subtype:'Espada',   slot:'Arma',    img:'https://i.ibb.co/9H915rgF/Gemini-Generated-Image-tmmniwtmmniwtmmn.png', effect:'katana_rayo', velBonus:15, desc:'+15 velocidad. Cuando un enemigo gana un turno adicional, aplica Mega Aturdimiento sobre él.' },
            'Nanoguante de Iron Man': { tier:'Epico',      slotCategory:'Equipacion', subtype:'Guantes',  slot:'Guantes', img:'https://i.ibb.co/5qyKrrM/Whats-App-Image-2026-08-13-at-12-49-39-PM.jpg', effect:'nanoguante_ironman', desc:'Gana Escudo Sagrado (2T) cuando un enemigo lo golpea con un Over. Roba 5 HP a un enemigo aleatorio cada vez que cualquier enemigo usa un Over.' },
        };
...
window.TRANSFORM_DATA = {
    'Caballero de la Muerte Arthas': {
        ...
        abilities: [
            ...
            { name: 'Escarcha Sangrienta',        type: 'special', cost: 7,  chargeGain: 0, damage: 5, target: 'aoe',    effect: 'dkarthas_frost', ignoresEsquivaArea:true,       description: 'Ignora Esquiva Área. 50% de aplicar Congelación. Por cada Congelación aplicada: +3 HP máximo al equipo aliado y +5 HP máximo a cada Campeón de la Muerte.' },
            { name: 'Corrupción de Almas',        type: 'special', cost: 7,  chargeGain: 0, damage: 5, target: 'aoe',    effect: 'dkarthas_corrupt', ignoresEsquivaArea:true,     description: 'Ignora Esquiva Área. 50% de aplicar 3 stacks de Veneno. Por cada Veneno aplicado: equipo aliado +3 cargas y cada Campeón de la Muerte +5 HP.' },
