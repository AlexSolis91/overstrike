// ==================== EJECUCIÓN DE HABILIDAD ====================
        ...
        function executeAbility(targetName) {
            ...
            // ══════════════════════════════════════════════════════
                ...
                // SHAKA — Octavo Sentido: el equipo aliado genera 1 carga por cada debuff activo en AMBOS equipos
                const _osShaka = gameState.characters[gameState.selectedCharacter];
                if (_osShaka) {
                    const _osMyTeam = _osShaka.team;
                    // Contar todos los debuffs activos en ambos equipos (personajes)
                ...
                // SHAKA — Ohm: el equipo aliado recupera 2 HP por cada debuff activo en AMBOS equipos
                const _ohmShaka = gameState.characters[gameState.selectedCharacter];
                if (_ohmShaka) {
                    const _ohmMyTeam = _ohmShaka.team;
                    // Contar todos los debuffs activos en ambos equipos
                    ...
                    if (_ohmTotalDebuffs === 0) {
                        ...
                        for (const _ohmAllyN in gameState.characters) {
                            ...
                            if (_ohmHealed > 0) {
                                ...
                                // Sub-pasiva Tesoro del Cielo: si Shaka recupera HP, aplica debuff aleatorio a enemigo aleatorio
                ...
                // Aplicar 3 debuffs aleatorios al objetivo
                ...
                if (_thTarget && !_thTarget.isDead && _thTarget.hp > 0) {
                    ...
                    // Filtrar no-stackeables que ya estén activos
